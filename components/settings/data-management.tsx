...
export function DataManagement() {
  ...
  return (
    <SectionCard title={t('settings.data.title')} description={t('settings.data.description')}>
      <div className="space-y-3">
        {/* Export */}
        <div className="flex items-center justify-between gap-4 rounded-xl bg-muted/40 px-4 py-3">
          <div className="space-y-0.5">
            <p className="text-sm font-medium text-foreground">{t('settings.data.exportTitle')}</p>
            <p className="text-xs text-muted-foreground">{t('settings.data.exportDescription')}</p>
          </div>
          <Button
            variant="outline"
            className="shrink-0"
        ...
        <div className="flex items-center justify-between gap-4 rounded-xl border border-negative/30 bg-negative/5 px-4 py-3">
          <div className="space-y-0.5">
            <p className="text-sm font-medium text-foreground">{t('settings.data.resetTitle')}</p>
            <p className="text-xs text-muted-foreground">{t('settings.data.resetDescription')}</p>
          </div>
          <ConfirmDialog
