...
function dueLabel(days: number, t: ReturnType<typeof useT>): { text: string; tone: string } {
  if (days < 0) return { text: t('dashboard.overdue', { n: -days }), tone: 'text-negative' };
  ...
  if (days <= 7) return { text: t('dashboard.dueInDays', { n: days }), tone: 'text-brass' };
  return {
