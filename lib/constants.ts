...
export const ICON_OPTIONS = [
  "Wallet", "PiggyBank", "CreditCard", "Banknote", "Coins", "TrendingUp",
  "Landmark", "Briefcase", "Laptop", "LineChart", "Percent", "Gift",
  "ShoppingCart", "ShoppingBag", "Utensils", "Coffee", "Home", "Zap",
  "Wifi", "Bus", "Car", "Fuel", "Plane", "Train", "HeartPulse", "Stethoscope",
  "ShieldCheck", "Clapperboard", "Music", "Gamepad2", "Repeat", "GraduationCap",
  "Dumbbell", "Sparkles", "PawPrint", "Baby", "HandHeart", "Receipt", "Phone",
  "Shirt", "Scissors", "TreePine", "Sun", "Umbrella", "Wrench", "Book",
  "Camera", "Palette", "Rocket", "Star", "MoreHorizontal",
];
