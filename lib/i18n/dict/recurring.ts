...
export const recurring: Dict = {
  es: {
    ...
    'recurring.deleteDesc': '«{name}» se eliminará. Las transacciones ya registradas se conservan.',
    'recurring.perMonth': '/mes',

    'recurring.editTitle': 'Editar recurrente',
    'recurring.newTitle': 'Nuevo recurrente',
    'recurring.editDesc': 'Actualiza esta factura, suscripción o ingreso recurrente.',
    'recurring.newDesc': 'Programa una factura, suscripción o flujo de ingresos recurrente.',
  ...
  en: {
    ...
    'recurring.description': 'Bills, subscriptions, and recurring income — always a step ahead.',
    ...
    'recurring.deleteDesc': '"{name}" will be removed. Posted transactions are kept.',
    'recurring.perMonth': '/mo',

    'recurring.editTitle': 'Edit recurring',
    'recurring.newTitle': 'New recurring',
    'recurring.editDesc': 'Update this bill, subscription, or recurring income.',
    'recurring.newDesc': 'Schedule a bill, subscription, or recurring income stream.',
