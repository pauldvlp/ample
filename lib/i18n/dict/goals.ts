...
export const goals: Dict = {
  es: {
    ...
    'goals.perMonth': '/mes',
    'goals.forecastHint': 'Agrega aportes para estimar una fecha de finalización',
    ...
    'goals.editDescription': 'Actualiza el objetivo, el plazo o los detalles de esta meta.',
    ...
    'goals.contributeDescription': 'Registra el dinero que apartas para esta meta.',
  ...
  en: {
    ...
    'goals.newDescription': 'Name a target, set an amount, and Ample will track your progress.',
