...
export const dashboard: Dict = {
  es: {
    ...
    "dashboard.description":
      "Una vista serena y completa de cómo está tu dinero hoy.",
    ...
    "dashboard.noSpendingDesc":
      "Los gastos de este mes se desglosarán aquí por categoría.",
    ...
    "dashboard.noBillsDesc":
      "Los cargos recurrentes de los próximos 30 días aparecerán aquí.",

    "dashboard.noGoals": "No hay metas activas",
    "dashboard.noGoalsDesc":
      "Define una meta de ahorro y observa cómo crece tu progreso.",
    ...
    "dashboard.noBudgetsDesc":
      "Crea presupuestos mensuales para mantener tus gastos bajo control.",
  ...
  en: {
    ...
    "dashboard.description":
      "A calm, complete view of where your money stands today.",
    ...
    "dashboard.noSpendingDesc":
      "Expenses this month will break down here by category.",
    ...
    "dashboard.noBillsDesc":
      "Upcoming recurring charges in the next 30 days will show here.",

    "dashboard.noGoals": "No active goals",
    "dashboard.noGoalsDesc":
      "Set a savings target and watch your progress build.",
    "dashboard.createGoal": "Create a goal",

    "dashboard.spentThisMonth": "Spent this month",
    "dashboard.noBudgets": "No budgets set",
    "dashboard.noBudgetsDesc":
      "Create monthly budgets to keep spending on track.",
