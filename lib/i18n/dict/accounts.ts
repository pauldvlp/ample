...
export const accounts: Dict = {
  es: {
    ...
    "accounts.description":
      "Todas las cuentas que registras y cómo suman tu patrimonio neto.",
    ...
    "accounts.includeInNetWorthDesc":
      "Suma esta cuenta a tu patrimonio neto total.",
  ...
  en: {
    ...
    "accounts.description":
      "Every account you track, and how they add up to your net worth.",
    ...
    "accounts.includeInNetWorthDesc":
      "Count this account toward your total net worth.",
