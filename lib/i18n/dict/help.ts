...
export const help: Dict = {
  es: {
    ...
    "help.dashboard.s3.body":
      "Tus activos menos tus pasivos y cómo evolucionan con el tiempo.",
    ...
    "help.transactions.s1.body":
      "El historial completo de tus ingresos, gastos y transferencias.",
    ...
    "help.goals.s1.body":
      "Ahorra para lo que importa y sigue el avance de cada meta.",
    "help.goals.s2.title": "Progreso total",
    "help.goals.s2.body":
      "Lo ahorrado frente a lo que te propusiste, con tu avance general.",
    ...
    "help.debts.s2.body":
      "Total que te deben, total que debes y tu posición neta de un vistazo.",
    "help.debts.s3.title": "Agregar una deuda",
    "help.debts.s3.body":
      "Registra un préstamo por cobrar o por pagar con su contraparte y monto.",
    ...
    "help.settings.s1.body":
      "Personaliza Ample: moneda, idioma, apariencia, IA y tus datos.",
  ...
  en: {
    ...
    "help.dashboard.s3.body":
      "Your assets minus your liabilities, and how they trend over time.",
    ...
    "help.accounts.s1.body":
      "Track every account here and see how they add up to your net worth.",
    "help.accounts.s2.title": "Balance summary",
    "help.accounts.s2.body":
      "Net worth, assets and liabilities computed from your accounts.",
    "help.accounts.s3.title": "Add an account",
    "help.accounts.s3.body":
      "Track a checking, savings, credit or investment account.",

    // ---- transactions ----
    "help.transactions.s1.title": "Your transactions",
    "help.transactions.s1.body":
      "The full history of your income, expenses and transfers.",
    ...
    "help.budgets.s2.body":
      "Switch months, add a budget, or copy last month's in a single click.",
    ...
    "help.goals.s1.body":
      "Save for what matters and follow the progress of each goal.",
    "help.goals.s2.title": "Overall progress",
    "help.goals.s2.body":
      "What you've saved against your targets, with your overall progress.",
    "help.goals.s3.title": "Create a goal",
    "help.goals.s3.body":
      "Set a target amount and date, and link it to a savings account.",
    ...
    "help.debts.s1.body":
      "Keep track of what you're owed and what you owe, and record payments.",
    "help.debts.s2.title": "Your position",
    "help.debts.s2.body":
      "Total owed to you, total you owe and your net position at a glance.",
    "help.debts.s3.title": "Add a debt",
    "help.debts.s3.body":
      "Record a receivable or a payable with its counterparty and amount.",
    ...
    "help.settings.s1.body":
      "Make Ample yours: currency, language, appearance, AI and your data.",
    "help.settings.s2.title": "General preferences",
    "help.settings.s2.body":
      "Name, base currency, language, date format and appearance options.",
