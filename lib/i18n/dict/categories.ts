...
export const categories: Dict = {
  es: {
    ...
    'categories.emptyDesc': 'Agrega tu primera categoría de {kind} para empezar a organizar.',
    ...
    'categories.newDesc': 'Dale a tus transacciones un lugar claro e identificado por color.',
    'categories.editDesc': 'Actualiza el nombre, tipo, ícono y color de esta categoría.',
  ...
  en: {
    ...
    'categories.emptyDesc': 'Add your first {kind} category to start organizing.',
    ...
    'categories.deleteDescTx': ' Its {n} transactions keep their history but become uncategorized.',
    'categories.deleteDescTxOne':
    ...
    'categories.editDesc': "Update this category's name, type, icon, and color.",
