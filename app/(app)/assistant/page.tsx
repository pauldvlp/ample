...
export default async function AssistantPage({
  ...
  const activeThreadId = requested && threads.some((th) => th.id === requested) ? requested : null;
  const initialMessages = activeThreadId ? await getThreadMessages(activeThreadId) : [];
