...
export const settings = sqliteTable("settings", {
  ...
  language: text("language", { enum: ["es", "en"] }).notNull().default("es"),
  ...
  simulationActive: integer("simulation_active", { mode: "boolean" })
    .notNull()
    .default(false),
...
export const transactions = sqliteTable(
  "transactions",
  {
    ...
    type: text("type", { enum: TRANSACTION_TYPES })
      .notNull()
      .default("expense"),
    ...
    payee: text("payee"),
    notes: text("notes"),
    status: text("status", { enum: TRANSACTION_STATUS })
      .notNull()
      .default("cleared"),
...
export const debts = sqliteTable(
  ...
  (t) => [
    index("debts_kind_idx").on(t.kind),
...
export const netWorthSnapshotBalances = sqliteTable(
